      ...
      <div className="relative z-10 min-h-screen flex flex-col">
        {result ? (
          ...
          <div className="flex flex-col w-full flex-grow animate-fade-in">
            ...
            <header className="w-full p-4 sm:p-6 backdrop-blur-md bg-white/93 border-b border-emerald-100/60 shadow-xl shadow-emerald-500/5">
                ...
                <div className="relative bg-white/96 backdrop-blur-xl rounded-3xl shadow-2xl shadow-slate-900/10 p-8 lg:p-12 border border-white/90 overflow-hidden">
                  ...
                  <div className="relative z-10">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                      ...
                      {/* Premium Submit Button with enhanced effects */}
                      <button
                        type="submit"
                        disabled={loading}
